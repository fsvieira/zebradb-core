...
describe('Not Tests.', function() {
    ...
    it('Should declare a number Set, 3 elements',
        test(
            ...
            ?(set (number 'a) 'tail ')`
            ,
            `?(set (number 0) (set (number 1) (set (number 2) (set) ') ') '): @(set @(number 0) @(set @(number 1) @(set @(number 2) @(set) ') @(set @(number 1) @(set) ')) @(set @(number 0) @(set @(number 2) @(set) ') @(set @(number 0) @(set) ')))[^!(equal @(number 0) @(number 1)) !(equal @(number 0) @(number 2)) !(equal @(number 1) @(number 2))] ?(set (number 'a) 'tail '): @(set @(number 0) @(set @(number 1) @(set @(number 2) @(set) ') @(set @(number 1) @(set) ')) @(set @(number 0) @(set @(number 2) @(set) ') @(set @(number 0) @(set) ')))[^!(equal @(number 0) @(number 1)) !(equal @(number 0) @(number 2)) !(equal @(number 1) @(number 2))] @(set @(number 0) @(set @(number 1) @(set) ') @(set @(number 0) @(set) '))[^!(equal @(number 0) @(number 1))] @(set @(number 0) @(set @(number 2) @(set @(number 1) @(set) ') @(set @(number 2) @(set) ')) @(set @(number 0) @(set @(number 1) @(set) ') @(set @(number 0) @(set) ')))[^!(equal @(number 0) @(number 1)) !(equal @(number 0) @(number 2)) !(equal @(number 2) @(number 1))] @(set @(number 0) @(set @(number 2) @(set) ') @(set @(number 0) @(set) '))[^!(equal @(number 0) @(number 2))] @(set @(number 0) @(set) ') @(set @(number 1) @(set @(number 0) @(set @(number 2) @(set) ') @(set @(number 0) @(set) ')) @(set @(number 1) @(set @(number 2) @(set) ') @(set @(number 1) @(set) ')))[^!(equal @(number 0) @(number 2)) !(equal @(number 1) @(number 0)) !(equal @(number 1) @(number 2))] @(set @(number 1) @(set @(number 0) @(set) ') @(set @(number 1) @(set) '))[^!(equal @(number 1) @(number 0))] @(set @(number 1) @(set @(number 2) @(set @(number 0) @(set) ') @(set @(number 2) @(set) ')) @(set @(number 1) @(set @(number 0) @(set) ') @(set @(number 1) @(set) ')))[^!(equal @(number 1) @(number 0)) !(equal @(number 1) @(number 2)) !(equal @(number 2) @(number 0))] @(set @(number 1) @(set @(number 2) @(set) ') @(set @(number 1) @(set) '))[^!(equal @(number 1) @(number 2))] @(set @(number 1) @(set) ') @(set @(number 2) @(set @(number 0) @(set @(number 1) @(set) ') @(set @(number 0) @(set) ')) @(set @(number 2) @(set @(number 1) @(set) ') @(set @(number 2) @(set) ')))[^!(equal @(number 0) @(number 1)) !(equal @(number 2) @(number 0)) !(equal @(number 2) @(number 1))] @(set @(number 2) @(set @(number 0) @(set) ') @(set @(number 2) @(set) '))[^!(equal @(number 2) @(number 0))] @(set @(number 2) @(set @(number 1) @(set @(number 0) @(set) ') @(set @(number 1) @(set) ')) @(set @(number 2) @(set @(number 0) @(set) ') @(set @(number 2) @(set) ')))[^!(equal @(number 1) @(number 0)) !(equal @(number 2) @(number 0)) !(equal @(number 2) @(number 1))] @(set @(number 2) @(set @(number 1) @(set) ') @(set @(number 2) @(set) '))[^!(equal @(number 2) @(number 1))] @(set @(number 2) @(set) ')
	        `
            ,
            {timeout: 60000}
        )
