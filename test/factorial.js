...
describe("Factorial Parser Tests.", function() {
    ...
    it("Should declare a mul func",
        test(
            ...
            ?(* (nat (nat 0)) (nat (nat 0)) 'r '):
                @(* @(nat @(nat 0)) @(nat @(nat 0)) @(nat @(nat 0)) @(list @(+ @(nat @(nat 0)) @(nat 0) @(nat @(nat 0)) ') @(list @(* @(nat @(nat 0)) @(nat 0) @(nat 0) '$1) @(list))))
            ?(* (nat (nat (nat 0))) (nat (nat 0)) 'r '):
                @(* @(nat @(nat @(nat 0))) @(nat @(nat 0)) @(nat @(nat @(nat 0))) @(list @(+ @(nat @(nat @(nat 0))) @(nat 0) @(nat @(nat @(nat 0))) ') @(list @(* @(nat @(nat @(nat 0))) @(nat 0) @(nat 0) '$1) @(list))))
            ?(* (nat (nat 0)) (nat (nat (nat 0))) 'r '):
                @(* @(nat @(nat 0)) @(nat @(nat @(nat 0))) @(nat @(nat @(nat 0))) @(list @(+ @(nat @(nat 0)) @(nat @(nat 0)) @(nat @(nat @(nat 0))) @(+ @(nat @(nat 0)) @(nat 0) @(nat @(nat 0)) ')) @(list @(* @(nat @(nat 0)) @(nat @(nat 0)) @(nat @(nat 0)) @(list @(+ @(nat @(nat 0)) @(nat 0) @(nat @(nat 0)) '$1) @(list @(* @(nat @(nat 0)) @(nat 0) @(nat 0) '$2) @(list)))) @(list))))
            ?(* (nat (nat (nat 0))) (nat (nat (nat 0))) 'r '):
                @(* @(nat @(nat @(nat 0))) @(nat @(nat @(nat 0))) @(nat @(nat @(nat @(nat @(nat 0))))) @(list @(+ @(nat @(nat @(nat 0))) @(nat @(nat @(nat 0))) @(nat @(nat @(nat @(nat @(nat 0))))) @(+ @(nat @(nat @(nat 0))) @(nat @(nat 0)) @(nat @(nat @(nat @(nat 0)))) @(+ @(nat @(nat @(nat 0))) @(nat 0) @(nat @(nat @(nat 0))) '))) @(list @(* @(nat @(nat @(nat 0))) @(nat @(nat 0)) @(nat @(nat @(nat 0))) @(list @(+ @(nat @(nat @(nat 0))) @(nat 0) @(nat @(nat @(nat 0))) '$1) @(list @(* @(nat @(nat @(nat 0))) @(nat 0) @(nat 0) '$2) @(list)))) @(list))))
            ?(* (nat (nat (nat 0))) (nat (nat (nat (nat 0)))) 'r '):
    ...
    it("Should declare a factorial func",
        test(
            ...
            ?(fac (nat 0) 'r '):
                @(fac @(nat 0) @(nat @(nat 0)) ')
            ?(fac (nat (nat 0)) 'r '):
                @(fac @(nat @(nat 0)) @(nat @(nat 0)) @(list @(* @(nat @(nat 0)) @(nat @(nat 0)) @(nat @(nat 0)) @(list @(+ @(nat @(nat 0)) @(nat 0) @(nat @(nat 0)) ') @(list @(* @(nat @(nat 0)) @(nat 0) @(nat 0) '$1) @(list)))) @(list @(fac @(nat 0) @(nat @(nat 0)) '$2) @(list))))
            ?(fac (nat (nat (nat 0))) 'r '):
