...
function union (branch, idsA, idsB) {
    ...
    r = r.map(function (o) {
        return branch.getObject(o);
    });
    
    return r;
}

clone = utils.profileFunc(clone, "clone", 0.01);
query = utils.profileFunc(query, "query", 0.01);
definitions = utils.profileFunc(definitions, "definitions", 0.01);
copyWithVars = utils.profileFunc(copyWithVars, "copyWithVars", 0.01);
union = utils.profileFunc(union, "union", 0.01);
