...
/* Tuple Declaration */
function DeclTuple (tuple) {
	this.tuple = tuple;
}

/* Variable Declaration */
function DeclVariable (name) {
	this.name = name;
}

Constant.prototype.context = function () {
	return this;
};

DeclTuple.prototype.context = function () {
	var tuple = [];
...
DeclVariable.prototype.context = function () {
	var context = new Context();
