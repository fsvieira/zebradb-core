...
ZVS.prototype.global = function (name) {
	var globalHash = this.objects.globals[name];
...
ZVS.prototype.transform = function (branchHash, oldCode, newCode) {
	oldCode = this.getId(branchHash, oldCode);
	newCode = this.getId(branchHash, newCode);
	if (oldCode !== newCode) {
